...
int SettingsBase::getLowAlert()
{
    return lowAlert;
}

int SettingsBase::getHighAlert()
{
    return highAlert;
}

int SettingsBase::getHealthAlert()
{
    return healthAlert;
}

int SettingsBase::getHighNotificationsInterval()
{
    return highNotificationsInterval;
}

int SettingsBase::getLowNotificationsInterval()
{
    return lowNotificationsInterval;
}

int SettingsBase::getHealthNotificationsInterval()
{
    return healthNotificationsInterval;
}

int SettingsBase::getLowLimit()
{
    return lowLimit;
}

int SettingsBase::getHighLimit()
{
    return highLimit;
}

int SettingsBase::getMaxChargeCurrent()
{
    return maxChargeCurrent;
}

int SettingsBase::getMaxSupportedChargeCurrent()
{
...
QString SettingsBase::getLowAlertFile()
{
    return lowAlertFile;
}

QString SettingsBase::getHighAlertFile()
{
    return highAlertFile;
}

QString SettingsBase::getHealthAlertFile()
{
    return healthAlertFile;
}

QString SettingsBase::getLogFilename()
{
    return logFilename;
}

QString SettingsBase::getNotificationTitle()
{
    return notificationTitle;
}

QString SettingsBase::getNotificationLowText()
{
    return notificationLowText;
}

QString SettingsBase::getNotificationHighText()
{
    return notificationHighText;
}

QString SettingsBase::getNotificationHealthTitle()
{
    return notificationHealthTitle;
}

QString SettingsBase::getNotificationHealthWarnText()
{
    return notificationHealthWarnText;
}

QString SettingsBase::getNotificationHealthCritText()
{
    return notificationHealthCritText;
}

int SettingsBase::getLogLevel()
{
    return logLevel;
}
