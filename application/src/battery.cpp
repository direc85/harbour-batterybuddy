...
Battery::Battery(Settings* newSettings, Logger* newLogger, QObject* parent) : QObject(parent)
{
    ...
    foreach(const QString& file, this->batteryFiles) {
    ...
    foreach(const QString& file, this->stateFiles) {
    ...
    foreach(const QString& file, this->usbPresentFiles) {
    ...
    foreach(const QString& file, this->acPresentFiles) {
