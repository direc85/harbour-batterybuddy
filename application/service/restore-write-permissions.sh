...
chmod 644 /sys/class/power_supply/primary_chg/online 2>/dev/null
chmod 644 /sys/class/qcom-battery/charging_enabled 2>/dev/null
chmod 644 /sys/class/qcom-battery/restrict_cur 2>/dev/null
chmod 644 /sys/class/qcom-battery/restrict_chg 2>/dev/null
exit 0
